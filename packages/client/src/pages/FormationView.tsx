  ...
  return (
    <AppLayout>
      ...
      <div className="flex flex-col md:flex-row gap-6 mt-4">
        {/* Pitch view */}
        <div className="flex justify-center md:flex-none md:w-[45%] self-start">
          <div ref={pitchRef} className="relative w-full max-w-lg aspect-[3/4] md:aspect-[8/9] rounded-xl overflow-hidden shadow-inner">
